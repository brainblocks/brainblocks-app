...
router.get('/vault/pinkey/:PIN', authenticate, validate, VaultsController.getPINKey);
router.post('/vault/pinkey/', authenticate, validate, VaultsController.createPINKey);
